...
export declare function enumerate<A>(xs: Iterable<A>): IterableIterator<[
    number,
    A
]>;
...
export declare function mkdict<A>(xs: Array<readonly [
    string,
    A
]>): Record<string, A>;
 ...
 */
export declare function partition<T>(xs: T[], pred: (x: T) => boolean): [
    T[],
    T[]
];
