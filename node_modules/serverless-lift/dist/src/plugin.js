...
Find all construct types available here: https://github.com/getlift/lift#constructs`,
  ...
  appendPermissions() {
    ...
    const constructs = this.getConstructs();
    const statements = (0, import_lodash.flatten)(
  ...
  getAllConstructClasses() {
    const result = (0, import_lodash.flatten)(
      _LiftPlugin.getAllProviderClasses().map((providerClass) => providerClass.getAllConstructClasses())
    );
    return result;
  }
